      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative">
              <img alt="SIVAR IA - Tecnología de inteligencia artificial" src="/lovable-uploads/36e20004-2775-4dda-9f2b-3620194d20fa.jpg" className="relative z-10 w-3/4 h-auto aspect-[16/9] rounded-2xl shadow-elegant object-cover mx-auto" />
            </div>
          </div>
        </div>
      </div>
